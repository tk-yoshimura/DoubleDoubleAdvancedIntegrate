...
namespace DoubleDoubleAdvancedIntegrate {
    public static partial class LineVectorIntegral {
        public static (ddouble value, ddouble error) Integrate(
            Func<ddouble, ddouble, ddouble, ddouble, (ddouble x, ddouble y, ddouble z, ddouble w)> f,
            Line4D line,
            ...
            for (int i = 0; i < ps.Count; i++) {
                ...
                (ddouble fx, ddouble fy, ddouble fz, ddouble fw) = f(x, y, z, w);

                ddouble v = fx * dxdt + fy * dydt + fz * dzdt + fw * dwdt;
