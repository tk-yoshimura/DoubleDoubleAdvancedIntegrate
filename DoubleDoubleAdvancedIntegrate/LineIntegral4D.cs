...
namespace DoubleDoubleAdvancedIntegrate {
    public static class LineIntegral4D {
        public static (ddouble value, ddouble error) Integrate(
            ...
            Func<ddouble, (ddouble, ddouble, ddouble, ddouble)> c, Func<ddouble, (ddouble, ddouble, ddouble, ddouble)> dc,
            ...
            for (int i = 0; i < ps.Count; i++) {
                ...
                (ddouble x, ddouble y, ddouble z, ddouble w) = c(t_shifted);
                (ddouble dx, ddouble dy, ddouble dz, ddouble dw) = dc(t_shifted);
