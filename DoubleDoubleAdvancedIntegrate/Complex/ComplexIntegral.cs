...
namespace DoubleDoubleAdvancedIntegrate {
    public static class ComplexIntegral {
        public static (Complex value, ddouble error) Integrate(
            ...
            Complex sg = ddouble.Zero, sk = ddouble.Zero;
            ...
            for (int i = 0; i < ps.Count; i++) {
                ...
                Complex z = line.Value(t), dz = line.Diff(t);
            ...
            ddouble error = (sk - sg).Norm;

            return (sk, error);
        }

        private static (Complex value, ddouble error, long eval_points) UnlimitedIntegrate(
            Func<Complex, Complex> f,
            Line2D line,
            ...
            Complex value_sum = 0d;
            ddouble error_sum = 0d;

            while (stack.Count > 0) {
                (range, eps) = stack.Pop();

                (Complex value, ddouble error) = Integrate(f, line, range, order);
        ...
        private static (Complex value, ddouble error, long eval_points) LimitedDepthIntegrate(
            Func<Complex, Complex> f,
            Line2D line,
        ...
        private static (Complex value, ddouble error, long eval_points) LimitedEvalIntegrate(
            Func<Complex, Complex> f,
            Line2D line,
        ...
        private static (Complex value, ddouble error, long eval_points) LimitedDepthAndEvalIntegrate(
            Func<Complex, Complex> f,
            Line2D line,
        ...
        public static (Complex value, ddouble error, long eval_points) AdaptiveIntegrate(
            Func<Complex, Complex> f,
            Line2D line,
            ...
            if (ddouble.IsZero(eps)) {
                (Complex value, ddouble error) = Integrate(f, line, range, order);
                eps = ddouble.Ldexp(value.Norm, -94);
